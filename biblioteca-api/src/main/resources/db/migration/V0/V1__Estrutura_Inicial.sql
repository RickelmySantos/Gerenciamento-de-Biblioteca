...
DROP TABLE IF EXISTS tb_emprestimo CASCADE;
DROP TABLE IF EXISTS tb_livros CASCADE;
DROP TABLE IF EXISTS tb_usuario CASCADE;
DROP TABLE IF EXISTS tb_autores CASCADE;
...
-- cspell:ignore autores sobrenome nacionalidade nascimento Britânica Britânico
...
('Harry Potter e a Pedra Filosofal', 'Rocco', 'Português', 'Fantasia', 6),
('19844', 'Companhia das Letras', 'Português', 'Distopia', 7),
('Orgulho e Preconceito', 'Penguin Classics', 'Inglês', 'Romance', 8);
...
('2025-01-01', '2025-01-15', 6, 1),
('2025-01-05', '2025-01-20', 7, 2),
('2025-01-10', '2025-01-25', 8, 3);
