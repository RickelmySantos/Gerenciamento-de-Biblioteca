        ...
        <div class="h-full flex justify-content-center align-items-center">
            <div class="w-8 md:w-5">
                <app-error-details
                    image="unavailable"
                    code="503"
                    [title]="'mensagem.error.503.titulo' | translate"
                    [description]="'mensagem.error.503.mensagem' | translate"
                ></app-error-details>
            </div>
        </div>
    `,
...
export class UnavailableServiceComponent extends BaseComponent {}
