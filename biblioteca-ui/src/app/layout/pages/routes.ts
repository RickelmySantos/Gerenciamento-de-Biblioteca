...
export default [
    {
        ...
        children: [
            { path: 'error', loadComponent: () => import('./error/unexpected-error.component').then(m => m.UnexpectedErrorComponent) },
            {
                ...
                loadComponent: () => import('./error/expired-session.component').then(m => m.ExpiredSessionComponent),
            },
            ...
            { path: 'not-found', loadComponent: () => import('./error/page-not-found.component').then(m => m.PageNotFoundComponent) },
            {
                ...
                loadComponent: () => import('./error/unavailable-service.component').then(m => m.UnavailableServiceComponent),
            },
            {
                path: 'unavailable-server',
                loadComponent: () => import('./error/unavailable-server.component').then(m => m.UnavailableServerComponent),
            },
